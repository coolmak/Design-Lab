...
?> 
 <html>
    ...
    <b>Start: </b>
    <input type="text" id="start" value="<?php echo $formattedAddrFrom; ?>" style="width:400px; "  readonly></input>
	<br/>
    <b>End: </b>
    <input type="text" id="end" value="<?php echo $formattedAddrTo; ?>" style="width:400px; " readonly></input>
	<button type="button" id="click" onclick="call()">Click Here</button>
    </div>
    <div id="map"></div>
		<script>
		function initMap() {
